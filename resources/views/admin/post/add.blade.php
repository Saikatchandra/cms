						...
						<form class="form-horizontal" action=" {{url('post')}} "  method="POST" enctype="multipart/form-data">
							...
							<fieldset>
							  ...
							  <div class="control-group">
								<label class="control-label" for="appendedInput"> Title</label>
								<div class="controls">
							  ...
							  <div class="control-group">
								<label class="control-label" for="appendedInput"> Body</label>
								<div class="controls">
								  <div class="input-append">
							   ...
							   <div class="control-group">
								...
								<div class="controls">
								  <div class="uploader"><input type="file" name="image"><span class="filename" style="user-select: none;">No file selected</span><span class="action" style="user-select: none;">Choose File</span></div>
								</div>
							  </div>
